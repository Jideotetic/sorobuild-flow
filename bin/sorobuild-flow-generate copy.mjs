...
# Public address for the configured Stellar CLI source identity.
# This is used by arguments.sh defaults such as DEPLOY_ADMIN.
resolve_source_address() {
  "$STELLAR_CLI" keys address "$SOURCE" 2>/dev/null || true
}
export SOURCE_ADDRESS="\${SOURCE_ADDRESS:-$(resolve_source_address)}"
